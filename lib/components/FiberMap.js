...
// React component for adding our own content to the map -- happens on selectedPosition event (I think)
class FiberMapContent extends Component {
  ...
  render(){
    ...
    // this.props get passed from FiberMap and get destructured in FiberMapContent.
    //where is map get passed from???
...
export default class FiberMap extends Component {
  ...
  render(){
    ...
    // it's ES6 Object destructuring syntax, take the setSelectedPosition out of this.props.
